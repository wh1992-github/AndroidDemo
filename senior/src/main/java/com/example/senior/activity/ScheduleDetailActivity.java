...
public class ScheduleDetailActivity extends AppCompatActivity implements
    ...
    private void enableEdit(boolean enabled) {
        ...
        if (enabled) {
            schedule_time.setBackgroundResource(R.drawable.edittext_selector);
            schedule_title.setBackgroundResource(R.drawable.edittext_selector);
            schedule_content.setBackgroundResource(R.drawable.edittext_selector);
        } else {
    ...
    //声明一个闹钟广播事件的标识串
    private final String ALARM_EVENT = "com.example.senior.activity.ScheduleDetailActivity.AlarmReceiver";
