...
open class CharacterParser {
    ...
    fun getSelling(chs: String): String {
        ...
        for (i in chs.indices) {
            ...
            value = if (key.toByteArray().size >= 2) {
                convert(key) ?: "unknown"
            } else {
                key
            }
    ...
    fun getSpelling(): String {
        return getSelling(resource!!)
    }

    companion object {
        private val pyvalue = intArrayOf(-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
        ...
        private val pystr = arrayOf("a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
        ...
        private val characterParser = CharacterParser()
