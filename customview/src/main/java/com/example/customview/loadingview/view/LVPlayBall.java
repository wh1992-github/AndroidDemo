...
public class LVPlayBall extends LVBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPath.moveTo(0 + mRadius * 2 + mPaintStrokeWidth, getMeasuredHeight() / 2);
        ...
        canvas.drawCircle(mWidth / 2, Math.max(ballY - mRadiusBall, mRadiusBall), mRadiusBall, mPaintBall);
    }
