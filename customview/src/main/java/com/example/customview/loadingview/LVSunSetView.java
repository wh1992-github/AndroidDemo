...
public class LVSunSetView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        initPaint();
        canvas.drawLine(0 + mWidth / 12, mHeight - mWidth / 6, mWidth - mWidth / 12, mHeight - mWidth / 6, mPaint);
        ...
        RectF oval1 = new RectF(mWidth / 2 - mWidth / 3, (float) ((float) (mHeight - mWidth / 6 - mWidth / 3) + Math.sin(Math.toRadians(sun_angle)) * mWidth / 3), mWidth / 2 + mWidth / 3, (float) (mHeight - mWidth / 6 + mWidth / 3 + Math.sin(Math.toRadians(sun_angle)) * mWidth / 3));
...
//        String tsStr = "2011-05-09 11:49:45";
    ...
    private Bitmap getSunbg(float intervalf) {
        ...
        if (intervalf < 1f) {
            RectF oval2 = new RectF(mWidth / 2 - mWidth / 3, (float) ((float) (mHeight - mWidth / 6 - mWidth / 3) + Math.sin(Math.toRadians(sun_angle)) * mWidth / 3), mWidth / 2 + mWidth / 3, (float) (mHeight - mWidth / 6 + mWidth / 3 + Math.sin(Math.toRadians(sun_angle)) * mWidth / 3));
    ...
    private Bitmap getSun(float intervalf) {
        ...
        if (intervalf > 0 && intervalf < 1) {
            ...
            c.drawLine(mWidth / 3 / 4 - mWidth / 3 / 10 - (mWidth / 3 / 10 / 5), mWidth / 3 / 4, mWidth / 3 / 4 - mWidth / 3 / 10 - (mWidth / 3 / 10 / 5) - (mWidth / 3 / 10 / 2), mWidth / 3 / 4, mPaint

            );
            c.drawLine(mWidth / 3 / 4 + mWidth / 3 / 10 + (mWidth / 3 / 10 / 5), mWidth / 3 / 4, mWidth / 3 / 4 + mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2), mWidth / 3 / 4, mPaint);
            c.drawLine(mWidth / 3 / 4, mWidth / 3 / 4 - mWidth / 3 / 10 - (mWidth / 3 / 10 / 5), mWidth / 3 / 4, mWidth / 3 / 4 - mWidth / 3 / 10 - (mWidth / 3 / 10 / 5) - (mWidth / 3 / 10 / 2), mPaint);
            c.drawLine(mWidth / 3 / 4, mWidth / 3 / 4 + mWidth / 3 / 10 + (mWidth / 3 / 10 / 5), mWidth / 3 / 4, mWidth / 3 / 4 + mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2), mPaint);
            c.drawLine((float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), mPaint);
            c.drawLine((float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), mPaint);
            c.drawLine((float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), mPaint);
            c.drawLine((float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 + ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), (float) (mWidth / 3 / 4 - ((float) (mWidth / 3 / 10 + (mWidth / 3 / 10 / 5) + (mWidth / 3 / 10 / 2)) / Math.sqrt(2))), mPaint);
        } else if (intervalf == 0) {
            RectF oval1 = new RectF();
            oval1.set(mWidth / 3 / 4 - mWidth / 3 / 10, mWidth / 3 / 4 - mWidth / 3 / 10, mWidth / 3 / 4 + mWidth / 3 / 10, mWidth / 3 / 4 + mWidth / 3 / 10);
