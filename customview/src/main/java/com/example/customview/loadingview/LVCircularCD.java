...
public class LVCircularCD extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setStrokeWidth(2);
        rectF = new RectF(mWidth / 2 - mWidth / 3, mWidth / 2 - mWidth / 3, mWidth / 2 + mWidth / 3, mWidth / 2 + mWidth / 3);
        canvas.drawArc(rectF, 0, 80, false, mPaint);

        canvas.drawArc(rectF, 180, 80, false, mPaint);

        rectF2 = new RectF(mWidth / 2 - mWidth / 4, mWidth / 2 - mWidth / 4, mWidth / 2 + mWidth / 4, mWidth / 2 + mWidth / 4);
    ...
    private void initPaint() {
        ...
        mProgressRotateAnim = new RotateAnimation(0f, 360f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    ...
    public void startAnim(int time) {
        stopAnim();
        mProgressRotateAnim.setDuration(time);
        startAnimation(mProgressRotateAnim);
    }
