...
import com.example.group.databinding.ActivityTabFragmentBinding;
import com.example.group.databinding.ItemTabbarBinding;
...
public class TabFragmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTabFragmentBinding.inflate(getLayoutInflater());
    ...
    private TabSpec getTabView(int textId, int imgId) {
        ...
        ItemTabbarBinding itemBinding = ItemTabbarBinding.inflate(getLayoutInflater());
        View item_tabbar = itemBinding.getRoot();
        TextView tv_item = itemBinding.tvItemTabbar;
