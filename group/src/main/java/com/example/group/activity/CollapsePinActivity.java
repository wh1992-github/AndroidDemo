...
import com.example.group.databinding.ActivityCollapsePinBinding;
...
public class CollapsePinActivity extends AppCompatActivity {
    private ActivityCollapsePinBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCollapsePinBinding.inflate(getLayoutInflater());
