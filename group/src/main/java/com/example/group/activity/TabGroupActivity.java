...
public class TabGroupActivity extends ActivityGroup implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTabGroupBinding.inflate(getLayoutInflater());
