...
import com.example.group.databinding.FragmentAppliancesBinding;
import com.example.group.widget.SpacesItemDecoration;

import java.util.ArrayList;
/**
 * 用于承载 Appliances 内容的 Fragment。
 */
...
public class AppliancesFragment extends Fragment implements OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentAppliancesBinding binding = FragmentAppliancesBinding.inflate(inflater, container, false);
        mView = binding.getRoot();
        //从布局文件中获取名叫srl_appliances的下拉刷新布局
        srl_appliances = binding.srlAppliances;
        ...
        rv_appliances = binding.rvAppliances;
        //创建一个垂直方向的瀑布流布局管理器
