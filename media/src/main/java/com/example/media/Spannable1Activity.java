 ...
 */
public class Spannable1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spannable1);
    ...
    private void initSpannableSpinner() {
        ArrayAdapter<String> spannableAdapter = new ArrayAdapter<>(this,
    ...
    class SpannableSelectedListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            if (arg2 == 0) { //增大字号
                spanText.setSpan(new RelativeSizeSpan(1.4f), mBeginPos, mEndPos,
                ...
                spanText.setSpan(new ImageSpan(Spannable1Activity.this, R.drawable.people),
