...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_spannable1).setOnClickListener(this);
        findViewById(R.id.btn_spannable2).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_spannable1) {
            Intent intent = new Intent(this, Spannable1Activity.class);
            startActivity(intent);
        } else if (v.getId() == R.id.btn_spannable2) {
            Intent intent = new Intent(this, Spannable2Activity.class);
            startActivity(intent);
