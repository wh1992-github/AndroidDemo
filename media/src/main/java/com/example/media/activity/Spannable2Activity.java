...
public class Spannable2Activity extends AppCompatActivity {
    ...
    private void mode11() {
        ...
        spannableString.setSpan(relativeSizeSpan, "暗影追踪已经开始暴走了".indexOf("已经"), "暗影追踪已经开始暴走了".length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
        TextView textView = (TextView) findViewById(R.id.mode11);
        textView.setText(spannableString);
    }
