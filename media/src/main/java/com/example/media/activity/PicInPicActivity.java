...
public class PicInPicActivity extends AppCompatActivity implements
    ...
    private void initDesktopReceiver() {
        ...
        //给当前页面注册广播接收器
        registerReceiver(mDesktopReceiver, intentFilter);
    }
    ...
    protected void onDestroy() {
        ...
        //注销当前页面的广播接收器
        unregisterReceiver(mDesktopReceiver);
    }
    ...
    public void onConfirmSelect(String absolutePath, String fileName, Map<String, Object> map_param) {
        ...
        //视频视图开始播放
        vv_content.start();
        String hint = String.format(Locale.getDefault(), "App正处于%s模式", isInPictureInPictureMode() ? "画中画" : "全屏");
    ...
    private DesktopReceiver mDesktopReceiver; //声明一个返回桌面的广播接收器对象
