...
public class ImageCache {
    ...
    //图片地址与视图控件的映射关系
    private HashMap<String, ImageView> mViewMap = new HashMap<>();
    //缓存队列,采用FIFO先进先出策略,需操作队列首尾两端,故采用双端队列
    private LinkedList<String> mFifoList = new LinkedList<>();
    ...
    public ImageCache initConfig(ImageCacheConfig config) {
        ...
        mHandler = new RenderHandler((Activity) mContext);
