...
/* dst = src in msk */
static void
duff_nimcn(byte *restrict sp0, int sw, int sn, byte *restrict mp0, int mw, int mn,
           byte *restrict dp0, int dw, int w0, int h) {
    int k;
    while (h--) {
        byte *sp = sp0;
        byte *mp = mp0;
...
static void
duff_nimon(byte *restrict sp0, int sw, int sn, byte *restrict mp0, int mw, int mn,
           byte *restrict dp0, int dw, int w0, int h) {
    int k;
    while (h--) {
        byte *sp = sp0;
...
static void
duff_1i1c1(byte *restrict sp0, int sw, byte *restrict mp0, int mw, byte *restrict dp0, int dw,
           int w0, int h) {
...
static void
duff_4i1c4(byte *restrict sp0, int sw, byte *restrict mp0, int mw, byte *restrict dp0, int dw,
           int w0, int h) {
...
static void
duff_1i1o1(byte *restrict sp0, int sw, byte *restrict mp0, int mw, byte *restrict dp0, int dw,
           int w0, int h) {
...
static void
duff_4i1o4(byte *restrict sp0, int sw, byte *restrict mp0, int mw, byte *restrict dp0, int dw,
           int w0, int h) {
...
static void
text_w4i1o4(byte *restrict argb, byte *restrict src0, int srcw, byte *restrict dst0, int dstw,
            int w0, int h) {
