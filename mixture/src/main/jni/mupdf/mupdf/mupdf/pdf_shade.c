...
static fz_error
pdf_loadcompositeshadefunc(fz_shade *shade, pdf_xref *xref, fz_obj *dict, fz_obj *funcref, float t0,
                           float t1) {
    fz_error error;
    pdf_function *func;
    int i;
...
static fz_error
pdf_loadcomponentshadefunc(fz_shade *shade, pdf_xref *xref, fz_obj *dict, fz_obj *funcs, float t0,
                           float t1) {
    fz_error error;
