...
segment->
min_coord = (FT_Short) min_pos;
segment->
max_coord = (FT_Short) max_pos;
segment->
height = (FT_Short)(segment->max_coord -
                    segment->min_coord);
...
if ( seg->dir == up_dir )
ups   += seg->max_coord-seg->
min_coord;
else
downs += seg->max_coord-seg->
min_coord;
...
af_latin_hints_compute_blue_edges( AF_GlyphHints
hints,
...
af_latin_hint_edges( AF_GlyphHints
hints,
AF_Dimension dim
)
{
...
if ( delta < 64 + 16 )
{
af_latin_align_serif_edge( hints, edge
->serif, edge );
