...
FT_READ_ULONG( sfnt
.format_tag )                    ||
FT_STREAM_READ_FIELDS( offset_table_fields,
&sfnt ))
goto
Exit;
...
table->
numNameRecords = (FT_UInt)(entry - table->names);
}
...
if (
FT_STREAM_READ_FIELDS( os2_fields_extra, os2
))
goto
Exit;
...
if (
FT_QNEW_ARRAY( gaspranges, num_ranges
) ||
