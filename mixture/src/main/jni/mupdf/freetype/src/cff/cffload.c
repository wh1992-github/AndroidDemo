...
FT_LOCAL_DEF( FT_String
* )
cff_index_get_sid_string( CFF_Index
idx,
FT_UInt sid,
        FT_Service_PsCMaps
psnames )
...
font->
num_global_subrs = font->global_subrs_index.count;
font->
...
/* /FontName otherwise)                                 */
font->
font_name = cff_index_get_name(&font->name_index, face_index);
