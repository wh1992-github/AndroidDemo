...
UCS4BEtoUCS4(unsigned char const *&s, void const *const eptr) {
    ...
    if (r <= eptr) {
        U = (((((((uint32_t) s[0] << 8) | (uint32_t) s[1]) << 8) | (uint32_t) s[2]) << 8) |
             (uint32_t) s[3]);
        if (U) {
            s = r;
        }
...
UCS4LEtoUCS4(unsigned char const *&s, void const *const eptr) {
    ...
    unsigned char const *const r = s + 4;
    if (r <= eptr) {
        U = (((((((uint32_t) s[3] << 8) | (uint32_t) s[2]) << 8) | (uint32_t) s[1]) << 8) |
             (uint32_t) s[0]);
        if (U) {
            s = r;
        }
...
UCS4_2143toUCS4(unsigned char const *&s, void const *const eptr) {
    ...
    unsigned char const *const r = s + 4;
    if (r <= eptr) {
        U = (((((((uint32_t) s[1] << 8) | (uint32_t) s[0]) << 8) | (uint32_t) s[3]) << 8) |
             (uint32_t) s[2]);
        if (U) {
            s = r;
        }
...
UCS4_3412toUCS4(unsigned char const *&s, void const *const eptr) {
    ...
    unsigned char const *const r = s + 4;
    if (r <= eptr) {
        U = (((((((uint32_t) s[2] << 8) | (uint32_t) s[3]) << 8) | (uint32_t) s[0]) << 8) |
             (uint32_t) s[1]);
        if (U) {
            s = r;
        }
