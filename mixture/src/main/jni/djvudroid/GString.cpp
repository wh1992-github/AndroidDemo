...
GP<GStringRep>
GStringRep::upcase(void) const { return tocase(giswupper, gtowupper); }

GP<GStringRep>
GStringRep::downcase(void) const { return tocase(giswlower, gtowlower); }
...
GUTF8String
GUTF8String::substr(int from, int len) const { return GUTF8String(*this, from, len); }

GUTF8String
GUTF8String::operator+(const GBaseString &s2) const { return GStringRep::UTF8::create(*this, s2); }

GUTF8String
GUTF8String::operator+(const GUTF8String &s2) const { return GStringRep::UTF8::create(*this, s2); }

GUTF8String
GUTF8String::operator+(const char *s2) const { return GStringRep::UTF8::create(*this, s2); }
...
GUTF8String::GUTF8String(const char dat) { init(GStringRep::UTF8::create(&dat, 0, 1)); }
...
GUTF8String::GUTF8String(const char *str) { init(GStringRep::UTF8::create(str)); }

GUTF8String::GUTF8String(const unsigned char *str) {
    init(GStringRep::UTF8::create((const char *) str));
}

GUTF8String::GUTF8String(const uint16_t *str) { init(GStringRep::UTF8::create(str, 0, -1)); }

GUTF8String::GUTF8String(const uint32_t *str) { init(GStringRep::UTF8::create(str, 0, -1)); }
...
GUTF8String::GUTF8String(const int number) { init(GStringRep::UTF8::create_format("%d", number)); }
...
GUTF8String &GUTF8String::operator=(const char *str) { return init(GStringRep::UTF8::create(str)); }
...
GUTF8String
operator+(const char *s1, const GUTF8String &s2) { return GStringRep::UTF8::create(s1, s2); }
