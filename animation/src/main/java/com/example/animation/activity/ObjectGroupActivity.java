...
public class ObjectGroupActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void initAnimator() {
        ...
        //构造一个在透明度上变化的属性动画
        ObjectAnimator anim2 = ObjectAnimator.ofFloat(iv_object_group, "alpha", 1f, 0.5f, 1f, 0.5f, 1f);
        //构造一个围绕中心点旋转的属性动画
        ...
        animSet.play(anim2).with(anim3).with(anim4).after(anim1).before(anim5);
        animSet.setDuration(3000); //设置动画的播放时长
